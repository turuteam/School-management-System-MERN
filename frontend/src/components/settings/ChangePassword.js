                ...
                <div className="row mb-3">
                    ...
                    <div className="col-sm-9">
                        <input 
                          ...
                          name="oldpassword"/>
                            {errors.oldpassword && <span className=" form-error text-danger mb-2">This field is required</span>}
                    </div>
                </div>
                <div className="row mb-3">
                    ...
                    <div className="col-sm-9">
                       <input 
                        ...
                        className="form-control" 
                        name="newpassword"/>
                          {errors.newpassword && <span className=" form-error text-danger mb-2">This field is required</span>}
                    </div>
                </div>
                <div className="row mb-3">
