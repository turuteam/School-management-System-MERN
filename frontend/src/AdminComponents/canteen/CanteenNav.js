...
function CanteenNav() {
    return (
        <div className="d-flex xs-flex-column sm-flex-row justify-content-end">
            ...
            <NavLink activeStyle={{ color: '#ffa201' }} className="btn" to="/canteen/addpayment">Make Payment</NavLink>
            <NavLink activeStyle={{ color: '#ffa201' }} className="btn" to="/canteen">All Payments</NavLink>
