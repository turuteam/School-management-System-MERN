...
function SettingsPage() {
    ...
    const handleEditname = (e) => {
        ...
        axios.put(`/school/update/${admin?.userID}`, {
    ...
    return (
        <div>
            <div className="content__container d-flex flex-column align-items-center mb-5">
               ...
               <h2>{editfullname} <span><EditIcon onClick={e => setOpen(true)}/></span></h2>
               <form  className="row">
                  ...
                  <div className="col-sm-6 mt-5">
                     ...
                     <button onClick={handleCancel} className="btn btn-danger ml-3">Cancel</button>
                  </div>
               </form>
